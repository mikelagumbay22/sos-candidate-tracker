    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
        ...
        <Button 
          ...
          className={cn(
            "p-0 h-6 w-6",
            collapsed && "absolute right-0 -mr-3 bg-white border border-gray-200 rounded-full z-10"
          )}
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-ats-blue-50 text-ats-blue-700"
                ...
                >
                  <item.icon className={cn(
                    ...
                    isActive ? "text-ats-blue-700" : "text-gray-500"
                  )} />
